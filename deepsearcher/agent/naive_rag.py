...
SUMMARY_PROMPT = """You are a AI content analysis expert, good at summarizing content. Please summarize a specific and detailed answer or report based on the previous queries and the retrieved document chunks, put your thinking progress in <think> </think>, and final output in <output> </output>.
...
class NaiveRAG(RAGAgent):
    ...
    def retrieve(self, query: str, **kwargs) -> Tuple[List[RetrievalResult], int, dict]:
        ...
        """
        consume_tokens = 0
        selected_collections = ["personalized_knowledge"]
